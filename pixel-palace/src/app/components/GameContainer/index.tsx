...
const GameContainer: React.FC = () => {
  ...
  return (
    <Layout className=" w-full min-h-screen flex flex-col ">
      ...
      <Content className="p-4 flex-1 overflow-y-auto mt-24 flex justify-center items-center">
        ...
        >
          {gamesToShow.map((game, index) => (
            <Col span={24} xs={24} xxl={24} sm={24} md={12} xl={8} lg={8} key={index}>
              <div className="flex items-center justify-center h-full">
                <Card className="bg-white shadow-lg max-w-md w-full h-full mx-2 md:mx-2 lg:mx-4">
                  <img
                    alt={game.nombre}
                    src={game.imagen}
      ...
      />
      <Footer className="bg-green-600 text-white p-4 text-center flex justify-between items-center mt-8 sm:justify-content-center-">
