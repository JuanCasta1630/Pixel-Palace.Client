...
import PaymentForm from "../components/Steper/steper";
    ...
    <ThemeProvider enableSystem={true} attribute='class'>
      <Layout className='w-full min-h-screen dark:bg-gray-700 bg-white'>
        ...
        <Content className="p-10 mt-10">
          <div className="max-w-md mx-auto p-6 m-10 rounded-md shadow-md">
            {step === 1 && (
              <>
                <h2 className="text-2xl font-bold mb-4">Step 1: Card Information</h2>
