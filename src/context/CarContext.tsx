...
export const CartProvider = ({ children }: { children: ReactNode }) => {
  ...
  const initialState: CartState = { cart: storedCart ? JSON.parse(storedCart) : [] };
  ...
  const value: CartContextProps = { state, dispatch, addToCart, removeFromCart, updateQuantity, clearCart };
