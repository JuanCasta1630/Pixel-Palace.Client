 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _signInWithCredential(e,t,r=!1){let i="signIn",n=await _processCredentialSavingMfaContextIfNecessary(e,i,t),s=await UserCredentialImpl._fromIdTokenResponse(e,i,n);return r||await e._updateCurrentUser(s.user),s}async function createUserWithEmailAndPassword(e,t,r){var i;let n;let s=_castAuth(e),a={returnSecureToken:!0,email:t,password:r,clientType:"CLIENT_TYPE_WEB"};if(null===(i=s._getRecaptchaConfig())||void 0===i?void 0:i.emailPasswordEnabled){let e=await injectRecaptchaFields(s,a,"signUpPassword");n=signUp(s,e)}else n=signUp(s,a).catch(async e=>{if("auth/missing-recaptcha-token"!==e.code)return Promise.reject(e);{console.log("Sign-up is protected by reCAPTCHA for this project. Automatically triggering the reCAPTCHA flow and restarting the sign-up flow.");let e=await injectRecaptchaFields(s,a,"signUpPassword");return signUp(s,e)}});let o=await n.catch(e=>Promise.reject(e)),l=await UserCredentialImpl._fromIdTokenResponse(s,"signIn",o);return await s._updateCurrentUser(l.user),l}function onAuthStateChanged(e,t,r,i){return(0,n.m9)(e).onAuthStateChanged(t,r,i)}function signOut(e){return(0,n.m9)(e).signOut()}new WeakMap;let f="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
